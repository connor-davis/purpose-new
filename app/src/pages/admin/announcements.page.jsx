    ...
    <div class="flex flex-col w-full h-full p-5">
      ...
      {viewingAnnouncement() && (
        <ViewAnnouncementModal
          data={{
            announcementDate: viewingAnnouncement().announcementDate,
            announcementTitle: viewingAnnouncement().announcementTitle,
            announcementMessage: viewingAnnouncement().announcementMessage,
          }}
          closed={() => {
