const StandardAlert = ({
  ...
  return (
    <>
      <div class="absolute left-0 top-0 right-0 bottom-0 flex flex-col items-center p-5">
        <div class="flex flex-col w-full md:w-auto space-y-3 border-l border-t border-r border-b border-neutral-700 bg-neutral-900 text-white rounded p-3">
